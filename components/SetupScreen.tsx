...
import { User, Wand2, RefreshCw, ChevronRight, Edit2, Loader2, Plus, Users } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            {!alias && (
              <button
                ...
                className={`w-full py-4 rounded-lg font-bold text-lg flex items-center justify-center space-x-2 transition-all ${!name ? 'bg-gray-700 cursor-not-allowed' : 'bg-dart-accent hover:bg-red-600 shadow-lg shadow-red-900/50'
                  }`}
              >
                {isGenerating ? (
                  <>
              ...
              <div className="animate-fade-in space-y-6">
                ...
                {isEditing && (
                  <div className="bg-dart-dark p-4 rounded-lg border border-gray-600">
                    <label className="block text-xs text-gray-400 mb-2">Describe changes</label>
                ...
                <div className="flex gap-3">
                  <button
                    onClick={handleGenerateIdentity}
                    className="flex-1 py-2 text-sm text-gray-400 hover:text-white flex items-center justify-center space-x-1 border border-gray-700 rounded-lg"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-bold flex items-center justify-center space-x-2"
                  >
